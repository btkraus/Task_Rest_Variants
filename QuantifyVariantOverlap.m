...
if AbsoluteThresholds == 1 && numel(thresholds) > 1
    ...
    outputdir = '/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Variant_Overlap_Plots/Thresholded_Plots/Absolute_Thresholds';
    outputdirsub = '/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Variant_Overlap_Plots/Thresholded_Plots/Subject_Plots/Absolute_Thresholds';
...
elseif numel(thresholds) > 1
    ...
    outputdir = '/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Variant_Overlap_Plots';
...
if SplitHalf == 1       %% Create variables for number of variants/average size
    ...
    NumVariantsTask = [];
    NumVariantsRest = [];
    MeanSizeVariantsTask = [];
    MeanSizeVariantsRest = [];
    MedianSizeVariantsTask = [];
    MedianSizeVariantsRest = [];
    
end

for v = 1:numel(thresholds)
    
    if SplitHalf == 1       %% Create temp variables for number of variants/average size
        ...
        NumVariantsTaskTemp = [];
        NumVariantsRestTemp = [];
        MeanSizeVariantsTaskTemp = [];
        MeanSizeVariantsRestTemp = [];
        MedianSizeVariantsTaskTemp = [];
        MedianSizeVariantsRestTemp = [];
    ...
    if FullMaps == 1
        ...
        [task_files, subjects1, tasks1] = textread('/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/MSC_alltask_varmaps_variants_SNRexclude.txt','%s%s%s');

        [rest_files, subjects2, tasks2] = textread('/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/MSC_rest_varmaps_variants_SNRexclude.txt','%s%s%s');
        
    elseif MatchedMaps == 1 && SNRExclude == 1 && SizeExclude == 1 && SplitHalf == 1 && numel(thresholds) > 1 && AbsoluteThresholds == 1

        [task_files_even, ~, ~] = textread(['/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/Thresholded_Maps/Absolute_Thresholds/Split_Half/MSC_alltask_even_varmaps_' num2str(thresholds(v)) '.txt'],'%s%s%s');

        [rest_files_even, ~, ~] = textread(['/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/Thresholded_Maps/Absolute_Thresholds/Split_Half/MSC_rest_even_varmaps_' num2str(thresholds(v)) '.txt'],'%s%s%s');
    ...
    elseif MatchedMaps == 1 && SNRExclude == 1 && SplitHalf == 1 && numel(thresholds) > 1
        ...
        [task_files_even, ~, ~] = textread(['/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/Thresholded_Maps/Split_Half/MSC_alltask_even_varmaps_' num2str(thresholds(v)) '.txt'],'%s%s%s');

        [rest_files_even, ~, ~] = textread(['/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/Thresholded_Maps/Split_Half/MSC_rest_even_varmaps_' num2str(thresholds(v)) '.txt'],'%s%s%s');
    
        [task_files_odd, subjects1, tasks1] = textread(['/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/Thresholded_Maps/Split_Half/MSC_alltask_odd_varmaps_' num2str(thresholds(v)) '.txt'],'%s%s%s');

        [rest_files_odd, subjects2, tasks2] = textread(['/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/Thresholded_Maps/Split_Half/MSC_rest_odd_varmaps_' num2str(thresholds(v)) '.txt'],'%s%s%s');
    ...
    elseif MatchedMaps == 1 && SNRExclude == 1
        ...
        [task_files, subjects1, tasks1] = textread('/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/MSC_alltask_varmaps_matched_variants_SNRexclude.txt','%s%s%s');

        [rest_files, subjects2, tasks2] = textread('/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/MSC_rest_varmaps_matched_variants_SNRexclude.txt','%s%s%s');
    ...
    for x = 1:nfiles
        ...
        if SplitHalf == 1       %% Get number of variants and mean/median size
            ...
            NumVariantsTaskTemp = [NumVariantsTaskTemp; length(vars_task)];
            NumVariantsRestTemp = [NumVariantsRestTemp; length(vars_rest)];
            MeanSizeVariantsTaskTemp = [MeanSizeVariantsTaskTemp; length(find(cifti_task.data > 0))/length(vars_task)];
            MeanSizeVariantsRestTemp = [MeanSizeVariantsRestTemp; length(find(cifti_rest.data > 0))/length(vars_rest)];
            
            vars_rest_size = zeros(length(vars_rest));
            vars_task_size = zeros(length(vars_task));
            
            for k = 1:length(vars_rest)
            
                vars_rest_size(k) = length(find(cifti_rest.data == vars_rest(k)));
                
            end
            
            for k = 1:length(vars_task)
            
                vars_task_size(k) = length(find(cifti_task.data == vars_task(k)));
                
            end
            
            MedianSizeVariantsTaskTemp = [MedianSizeVariantsTaskTemp; median(vars_task_size)];
            MedianSizeVariantsRestTemp = [MedianSizeVariantsRestTemp; median(vars_rest_size)];
...
%         finalrestvarcount = length(unique(find(restdata > 0)));
    ...
    if SplitHalf == 1       %% Add temp variables to final variables
        ...
        NumVariantsTask = [NumVariantsTask NumVariantsTaskTemp];
        NumVariantsRest = [NumVariantsRest NumVariantsRestTemp];
        MeanSizeVariantsTask = [MeanSizeVariantsTask MeanSizeVariantsTaskTemp];
        MeanSizeVariantsRest = [MeanSizeVariantsRest MeanSizeVariantsRestTemp];
        MedianSizeVariantsTask = [MedianSizeVariantsTask MedianSizeVariantsTaskTemp];
        MedianSizeVariantsRest = [MedianSizeVariantsRest MedianSizeVariantsRestTemp];
