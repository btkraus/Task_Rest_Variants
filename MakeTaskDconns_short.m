%% Questions
% Can we combine this with scrip to make rest dconns? Add rest as a fourth
% task?
% What are the "remainder" variables? (line 95 and after)
...
for i=1:numel(subs)
    ...
    for j=1:length(tasks)
        ...
        %% determines # of sample points for each task
        memptsodd = [];
        motorptsodd = [];
        mixedptsodd = [];
        memptseven = [];
