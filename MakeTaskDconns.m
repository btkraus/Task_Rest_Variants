...
% Written by Brian Kraus, edited by Diana Perez, Zach Ladwig 
...
for i=1:numel(subs)
    ...
    for j=1:length(tasks)
        ...
        sampspersession = GetSampsPerSession(mintasksamps, tasks{j}, subs{i}, QCFiles_path,SplitHalf, MatchData, ConcatenateTasks);
        ...
        disp([MSCTaskdir '/' subs{i} '_' tasks{j} '_DATALIST.txt']);
