...
[test_files, subjects1, ~] = textread('/Users/briankraus/Desktop/Poldrome_Data/MSC_rest_consec_Fullvarmaps_unmatched.txt','%s%s%s');

[true_files, subjects2, ~] = textread('/Users/briankraus/Desktop/Correct_Variant_Maps/MSC_Data/Text_Lists/Reliability_Files/MSC_rest_even_full_varmaps.txt','%s%s%s');
...
ylim([0 1]);
hold on
plot(times(1:14),CiftiCorrs{8,:},'Color',[0, 0.6, 0.6],'LineWidth', 3)
hold on
...
hold on
plot(times,CiftiCorrs{3,:},'Color',[0, 1, 0],'LineWidth', 3)
hold on
...
print(gcf,[outputdir 'Reliability Rest Data Pearson.jpg'],'-dpng','-r300');
...
ylim([0 1]);
hold on
plot(times(1:14),DiceCorrs{8,:},'Color',[0, 0.6, 0.6],'LineWidth', 3)
hold on
...
hold on
plot(times,DiceCorrs{3,:},'Color',[0, 1, 0],'LineWidth', 3)
hold on
...
print(gcf,[outputdir 'Reliability Rest Data Dice ' num2str(threshold) '.jpg'],'-dpng','-r300');
